    ...
    while running:
        ...
        if player.health > 0:
            ...
            if not bigboss:
                ...
                button("Click for End Screen", 350, 340, 270, 50, GREEN, PASTEL_ORANGE, action= "end_screen") #button to redirect the player to the end screen
        else:
            ...
            button("Click for End Screen", 350, 340, 270, 50 , RED, PASTEL_ORANGE, action= "end_screen") #button to redirect player to end screen
